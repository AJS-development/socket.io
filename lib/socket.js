...
Socket.prototype.emit = function (ev) {
    if (~exports.events.indexOf(ev)) {
        ...
        var packet = {
            type: (this.flags.hasBinary === true || (this.flags.hasBinary === undefined && hasBin(args))) ? parser.BINARY_EVENT : parser.EVENT,
            data: args
        };
...
Socket.prototype.ack = function (id) {
    ...
    return function () {
        ...
        var type = (this.flags.hasBinary === true || (this.flags.hasBinary === undefined && hasBin(args))) ? parser.BINARY_ACK : parser.ACK;
        self.packet({
            id: id,
            type: type,
            data: args
